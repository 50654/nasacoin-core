    ...
    async updateWalletDisplay() {
        ...
        if (this.connectedWallet) {
            ...
            try {
                ...
                walletBalance.textContent = `${balance} NASAPEPE`;
            } catch (error) {
                walletBalance.textContent = 'Error loading balance';
            }
            
            walletActions.innerHTML = `
                <button id="sendTransaction" class="btn btn-primary">
                    <i class="fas fa-paper-plane"></i> Send
                </button>
                <button id="disconnectWallet" class="btn btn-outline">
            ...
            walletAddress.value = '';
            walletBalance.textContent = '0 NASAPEPE';
            
            walletActions.innerHTML = `
                <button id="connectMetaMask" class="btn btn-primary">
                    <i class="fab fa-ethereum"></i> Connect MetaMask
                </button>
                <button id="connectCoinbase" class="btn btn-secondary">
                    <i class="fas fa-wallet"></i> Connect Coinbase
                </button>
            `;
